...
exports.up = function(knex, Promise) {
    return Promise.all([
        ...
        knex.schema.createTable('Event', function (table) {
            table.bigIncrements('event_id').primary().unsigned();
        ...
        knex.schema.createTable('Organization', function (table) {
            ...
            table.string('email').references('email').inTable('OrgApproved');
        ...
        knex.schema.createTable('Org_Event', function (table) {
            table.bigInteger('event_id').unsigned().notNullable().references('event_id').inTable('Event');
            table.bigInteger('org_id').unsigned().notNullable().references('org_id').inTable('Organization');
        }),
        ...
        knex.schema.createTable('Place', function (table) {
            ...
            table.bigInteger('org_id').unsigned().notNullable().references('org_id').inTable('Organization');
            table.bigInteger('type_id').unsigned().notNullable().references('type_id').inTable('Place_Type');
        ...
        knex.schema.createTable('Login', function (table) {
            ...
            table.string('user_name').notNullable().references('user_name').inTable('Organization');
        ...
        knex.schema.createTable('Person', function (table) {
            ...
            table.string('user_name').notNullable().references('user_name').inTable('Login');
        ...
        knex.schema.createTable('Event_Tag', function (table) {
            table.bigInteger('tag_id').unsigned().notNullable().references('tag_id').inTable('Tag');
            table.bigInteger('event_id').unsigned().notNullable().references('event_id').inTable('Event');
        }) 
